...
c. Create a histogram of annual sea level rise using `ggplot()`. Label the x- and y-axes.   
d. Create a timeseries plot with points and a line representing cumulative sea level rise through time (year on the x-axis, cumulative sea level rise on the y-axis) using `ggplot()`. Label the x- and y-axes.   
