...
You decide to measure plant growth for individual pickleweed plants by plucking an individual out of the ground and measuring the biomass (in g). You also measure salinity at the location in which the individual was growing (in grams of salt per kg of water, measured in parts per thousand). Admittedly, this isn't a perfect study, but it's what you can do with the time and resources you have!
...
Create a visualization that would be appropriate for showing the relationship between soil salinity (measured in ppt) and California pickleweed biomass (measured in g).  
