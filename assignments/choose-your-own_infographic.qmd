---
title: "Choose your own assignment - Infographic"
editor: source
...
**Optional check in:** Thursday 21 May
  ...
  For your optional check in, you should have parts 1 and 2 done.

**Required check in:** Thursday 28 May

  For your required check in, you should have part 3 done (a rough draft). 
...
- Leela Dixit's [Exploring the Success and Setbacks of the White Abalone Captive Breeding Program](https://lsdixit.github.io/posts/2026-03-05-white-abalone-infographic/)
- Melannie Moreno Rolón's [Visualizing Storm Impacts in Puerto Rico](https://mmorenorolon.github.io/posts/2026-03-09-pr-storms-infographic/)
- Vedika Shirtekar's [The Anatomy of a Spotify Hit](https://vedikas-byte.github.io/mysite/posts/spotify-infographic/) 
...
- [ ] a title
- [ ] your name
- [ ] text accompanying each figure that contribute to the story you're telling (note that this is not a caption! see the examples in the "Infographics" section of this assignment for examples)
...
### Part 1. Choose 4-5 types of visualizations you might be able to make with your data.
...
Some examples of interesting visualizations include:
...
If none of these examples speak to you, you could scroll through the #tidytuesday hashtag on X to see what visualizations people are making with the weekly data sets ([link](https://x.com/search?q=tidytuesday&src=typed_query)).  
...
### Part 2. Update your data entry and plan your visualizations.
...
Create a .qmd file to code your visualizations.  
...
#### b. Arrange your visualizations using the design platform of your choosing.
...
- [ ] your .qmd with all your code
- [ ] your rendered/knitted file in .pdf format
- [ ] your final infographic (separate from the rendered/knitted file)
- [ ] organized files (separate folders for data, code, and images - so your code should incorporate use of the `here` package)
- [ ] a README with a links to the .pdf and the final infographic
