...
Check the [Google sheet](https://docs.google.com/spreadsheets/d/1iGh39-AZ0RoEuY3VqjUQ_JORli-2wQ_O6EPRl20iy6k/edit?usp=sharing) and choose a paper to use for your critique based on An’s/Thuy-Tien's/Grace's recommendations. Answer the following questions about the paper in 1-2 sentences each:  
