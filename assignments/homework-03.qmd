...
[Due on Thursday 28 May at 11:59 PM]{style="color: #79ACBD; font-size: 24px;"}
...
3. Add your `.Rproj` file to the `gitignore`.
...
6. Create a new Quarto for your homework submission. Save it to the `code` folder.
7. Download the kelp data to your `data` folder.
8. Do all of your set up (reading in packages/data) at the top of your .qmd file.  
  ...
  - Store the kelp data as an object called `kelp`.  
...
Climate change threatens all ecosystems, including giant kelp (_Macrocystis pyrifera_) forests.
...
Double check your understanding of the appropriate test. You are trying to understand the _strength of the relationship_ between temperature and giant kelp frond elongation rate.
:::
...
In part a, you outlined _two_ potential tests to answer this question about the strength of the relationship between temperature and giant kelp front elongation rate. In part c, you chose a test, checked your assumptions, and ran one.  
...
**Note:** if you think that a _different_ plot type or _different_ variables would be more interesting to visualize - or if you received feedback in which you were recommended to make a different plot - then change your plots.
...
- [ ] include a table of contents (see code from workshop 7 and 8 for a reference in the YAML at the top of the `.qmd` file)  

Additionally, your rendered pdf should include the components listed below:  

- [ ] a set up chunk at the top of the document, where you have read in your packages and your data using the `here` package (and you should not have read in any packages or data anywhere else)  
