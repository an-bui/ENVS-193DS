...
citation:
  url: https://winter-2026.envs-193ds.com/lecture/lecture_week-01.html
---
...
pretend_diameters <- cbind(
  Starburst = rnorm(20, mean = 12, sd = 4), 
  `Giant green` = rnorm(20, mean = 17, sd = 5), 
  Moonglow = rnorm(20, mean = 8, sd = 2)
) %>% 
  as_tibble() %>% 
