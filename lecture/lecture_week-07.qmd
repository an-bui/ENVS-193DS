...
citation:
  url: https://winter-2026.envs-193ds.com/lecture/lecture_week-07.html
---
...
If you were to imagine the following equation describing the predictive relationship between temperature and abalone mass:
...
$$
\rho_s = 1 - \frac{6 \Sigma d_i^2}{n(n^2-1)}

$$

From [UVA](https://library.virginia.edu/data/articles/correlation-pearson-spearman-and-kendalls-tau): $d_i^2$ is the squared difference in ranks, and $n$ is the number of paired values. 6 in the numerator ensures that calculated $\rho_s$ values are between -1 and 1. 
