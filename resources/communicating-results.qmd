...
Generally, the font size in captions tends to be smaller than the main text. You can insert these options in Quarto by wrapping your text in a "fenced div" (see the source code for how to do that). In RMarkdown, you can use an HTML wrapper (here's an [example](https://html-shark.com/HTML/TextSizeType.htm)).
:::
...
There is an example of a repository and a full report [here](). 
