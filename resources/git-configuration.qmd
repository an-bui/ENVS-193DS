...
We are going to start using Git/GitHub in class during week 7 (Friday the 20th of February). You can get help to set up in:  

- drop-in hours (Wednesday the 11th, Thursday the 12th, Wednesday the 18th, Thursday the 19th)
- in workshop on Friday the 13th (come to any workshop meeting, you don't have to come to the one you're enrolled in). **You will earn one (1) token for coming to workshop and having An/Amanda check your set up.**
...
Now go to [Git/GitHub Part 2: setting your personal access token](https://winter-2026.envs-193ds.com/resources/storing-personal-access-token).
