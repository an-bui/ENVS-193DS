...
If you have not created a GitHub account and entered your information in the **Terminal**, go back to [Part 1](https://winter-2026.envs-193ds.com/resources/git-configuration) and complete those steps before moving on to the steps in this part.
...
Come to workshop on Friday the 13th (either 9 AM or 12 PM, doesn't have to be the one you're enrolled in) and have An or Amanda check your set up in exchange for one (1) token.
