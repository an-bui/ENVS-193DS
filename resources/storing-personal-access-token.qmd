...
If you have not created a GitHub account and entered your information in the **Terminal**, go back to [Part 1](https://spring-2026.envs-193ds.com/resources/git-configuration) and complete those steps before moving on to the steps in this part.
...
There is a video going through all these steps on the Resources page on Canvas (and [here](https://gauchocast.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=82a1a368-6012-41cd-b0c0-b174015aa955)).
...
Under "Note", name your PAT. A logical name could be "PAT spring 2026".  
...
Come to workshop on Friday the 8th (either 9 AM or 12 PM, doesn't have to be the one you're enrolled in) and have An check your set up in exchange for one (1) token.
