...
:::{.callout-warning title="Still updating!"}
As of the 28th of March, the virtual machine is not ready yet! I'll update this page once it is.
:::
...
If you're opening this up for the first time, do task 3 in the Getting set up guide: [Change your workspace save settings](https://spring-2025.envs-193ds.com/assignments/getting-set-up#task-3.-change-your-workspace-save-settings).
