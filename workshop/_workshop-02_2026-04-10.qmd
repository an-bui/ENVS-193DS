...
ggplot(data = production_clean, # start with the production_clean data frame
       mapping = aes(x = type, # x-axis should be type of production
...
ggplot(data = production_summary, # use the summary data frame
       mapping = aes(x = type, # x-axis should be production type
...
ggplot(data = production_summary, # use the summary data frame
       mapping = aes(x = type, 
                     ...
                     color = type)) + # color the points by fishery type
  geom_point(size = 2) + # plot the mean
  geom_errorbar(aes(ymin = ci_lower, # plot range of values defining 95% CI
                    ymax = ci_upper),
                width = 0.1) +
...
ggplot(data = production_clean,
  ...
  scale_color_manual(values = c("aquaculture" = "deepskyblue3",
                                "capture" = "orangered1")) +
