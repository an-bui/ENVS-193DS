...
categories: [tidyverse, readxl, here, janitor, GGally, MuMIn, ggeffects, gtsummary, flextable, modelsummary, relocate, ggpairs, model.sel, as_flextable, tbl_regression, modelsummary, ggpredict, reorder, summary, pipe (%>%) operator, github, forking, str, class]
format:
  html:
    toc: true
    toc-depth: 5
...
- look at data using `str()` and `class()`  
