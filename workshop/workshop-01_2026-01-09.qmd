...
[Workshop date: Friday 9 January]{style="color: #79ACBD; font-size: 24px;"}
...
Type `View(parks_visits)` in the console.
...
Note: only use `View()` in the console! 
...
mean_jtnp_visits <- parks_visits |> # start with the `parks_visits` data frame
