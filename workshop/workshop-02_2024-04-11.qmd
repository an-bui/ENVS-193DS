...
categories: [tidyverse, janitor, read_csv, pipe (%>%) operator, clean_names, mutate, select, pivot_longer, rename, group_by, summarize, sd, qt, ungroup, ggplot, geom_histogram, geom_point, geom_errorbar, geom_pointrange, extra stuff, fisheries]
---
...
global_catch_summary <- global_catch_clean %>% 
  ...
  ungroup() # ungroup the data frame (good practice to do this after every group_by())
```
