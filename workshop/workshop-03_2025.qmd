...
[Workshop dates: April 16 (Thursday), April 17 (Friday)]{style="color: #79ACBD; font-size: 24px;"}
...
**n = 120 for calcium-treated, n = 120 for reference**  
...
**We found a significant difference in sugar maple stem lengths between calcium-treated (n = 120) and reference watersheds (n = 120) (Student's t-test, t(238) = 3.8, p < 0.001).**    
