...
ggplot(data = maples_2003) +
  geom_density(aes(x = stem_length, fill = watershed), alpha = 0.6, color = "black", position = "identity") +
  scale_fill_manual(values = c("Calcium-treated" = "#FF6B2B", "Reference" = "#00A38D")) +
  theme_bw() +
  theme(panel.grid = element_blank())
...
xAxB <- mean_w1_2003 - mean_ref_2003

xAxB-qt(0.975, df = n_ref_2003 + n_w1_2003 - 2)*sqrt(((n_ref_2003 - 1)*var_ref_2003 + (n_w1_2003 - 1)*var_w1_2003)/(n_ref_2003 + n_w1_2003 - 2))*sqrt((1/n_ref_2003) + (1/n_w1_2003))
...
d_effsize <- cohens_d(stem_length ~ watershed, data = maples_2003)
```
