...
categories: [tidyverse, lterdatasampler, paletteer, ggthemes, tvthemes, ggpomological, gghighlight, patchwork, gganimate, ggimage, plotly, mutate, filter, ggplot, geom_point, geom_line, case_when, fct_relevel, theme]
format:
  html:
    toc: true
    toc-depth: 5
